...
//     </div>
//   </nav>
    <nav className="w-full bg-purple-800 p-4 shadow-md flex gap-2 items-center justify-between sticky top-0 z-10">
      <a href="/" className="bg-purple-600 text-white font-bold px-2 py-2 rounded-md  cursor-pointer">
        InstaNinja
      </a>
