...
const Testimonial = () => {
    const comments =[
        ...
        { name: "Mohid", comment: "Great app! Helped me a lot in my daily tasks." },
        ...
        <section className="max-w-6xl mx-auto py-12 bg-white relative flex flex-col items-center">
            <div className="container mx-auto px-4 flex flex-col lg:flex-row">
                ...
                <div className="w-full ">
                    <h2 className="text-3xl font-bold text-center mb-8 text-purple-800">What Our Users Say</h2>
                            ...
                            {comments.map((item) => (
                                <div key={item} className="bg-white p-6 rounded-lg shadow-md">
                                    ...
                                    <div className="mt-4 flex items-center">
                                        ...
                                        <p className="ml-3 font-semibold text-purple-800"> {item.name}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
